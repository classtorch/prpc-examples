...
type UserClient interface {
	...
	//获取单个用户信息
	GetUserInfo(ctx context.Context, in *GetUserInfoReq, opts ...http.CallOption) (*GetUserInfoReply, error)
}
...
func (c *userClient) GetUserInfo(ctx context.Context, in *GetUserInfoReq, opts ...http.CallOption) (*GetUserInfoReply, error) {
	out := new(GetUserInfoReply)
	header := map[string]string{
		"Content-Type": "application/json",
	}
	opts = http.CallOptions(opts).CombineHeader(header)
	err := c.cc.HttpInvoke(ctx, "GET", "/users/{uid}/info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
